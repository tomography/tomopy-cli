...
class AbsorptionCalcTests(unittest.TestCase):
    def setUp(self):
        ...
        bh.scintillator_material = bh.Material('LuAG_Ce', 6.73)
        bh.sample_material = self.Al_filter
        bh.scintillator_thickness = 100
        bh.threshold_trans = 1e-5
    ...
    def test_ffind_calibration_one_angle(self):
        ...
        test_spline = softener.ffind_calibration_one_angle(self.fake_spectrum)
